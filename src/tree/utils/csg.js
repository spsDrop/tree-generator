 ...
 */
 ...
 class Vertex {
     ...
     clone() {
         return new Vertex(this.pos, this.normal, this.color);
     }
     ...
     interpolate(other, t) {
         return new Vertex(this.pos.clone().lerp(other.pos, t), this.normal.clone().lerp(other.normal, t), this.color && other.color && this.color.clone().lerp(other.color, t));
     }
 }
 // # class Plane
 ...
 Node.fromJSON = function (json) {
     return CSG.fromPolygons(json.polygons.map((p) => new Polygon(p.vertices.map((v) => new Vertex(v.pos, v.normal)), p.shared)));
 };
